...
const NavBar = () => {
  ...
  return (
    <div className={`${styles.paddingX} ${styles.flexCenter}`}>
      <nav className="w-full flex pt-3 pb-6 justify-between items-center navbar">
        <div className='text-white' style={{ fontFamily: 'Orbitron, sans-serif', fontSize: '2rem' }}>WatchTower</div>
